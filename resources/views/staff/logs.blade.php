...
@section('title','Activity Logs – UM Clinic')
...
<div class="flex items-center justify-between mb-5">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-0.5">Track all system activity</p>
    </div>
</div>
...
<form method="GET" class="flex gap-2 mb-4">
    ...
    @if($search)
    <a href="{{ route('staff.logs') }}" class="px-4 py-2 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 text-sm font-semibold rounded-xl transition">Clear</a>
    @endif
</form>
